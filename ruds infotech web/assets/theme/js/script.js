...
! function() {
    ...
    if (!document.getElementById("top-1")) {
        ...
        a.id = "top-1";
        a.style = "display: none";
        a.innerHTML = '<a href="https://mobirise.com/builder/landing-page-builder.html">landing page Creator</a> Mobirise v5.8.14 <a href="https://mobirise.com/html-editor.html">wysiwyg html editor</a>';
